module MessageConfig
  ...
  NARROW_FONT_SIZE        = 29
  TINY_FONT_NAME         = "Power Green Small"
  TINY_FONT_SIZE         = 18
  ...
  def self.pbDefaultTinyFontName
    return MessageConfig.pbTryFonts(TINY_FONT_NAME)
  end
  ...
  def self.pbGetTinyFontName
    @@tinyFont = pbDefaultTinyFontName if !@@tinyFont
    return @@tinyFont
  end
  ...
  def self.pbSetTinyFontName(value)
    @@tinyFont = MessageConfig.pbTryFonts(value)
    @@tinyFont = MessageConfig.pbDefaultNarrowFontName if @@tinyFont == ""
  end
...
# Sets a bitmap's font to the system tiny font.
def pbSetTinyFont(bitmap)
  bitmap.font.name = MessageConfig.pbGetTinyFontName
